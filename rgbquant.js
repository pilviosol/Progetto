...
(function(){
	function RgbQuant(opts) {
		...
		// palette grouping
		this.hueGroups = opts.hueGroups || 12; // ** DEFAULT WAS 10 **
...
//		l = Math.floor(l * 100)
    ...
    // returns array of sorted values from a dictionary
	function sortedValues(obj, desc) {
        var values = [];
		...
		return sort.call(values, function(a,b) {
			return desc ? b - a : a - b;
		});
    }
    
    // ** NOT IN THE ORIGINAL CODE **
    // returns sorted color occurrences
    RgbQuant.prototype.histFrequencies = function histFrequencies() {
        var histG = this.histogram;
        var freqs = sortedValues(histG, true);
        return freqs;
    }
